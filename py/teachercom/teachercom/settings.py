...
DEFAULT_FROM_EMAIL = 'info@teachercom.org'
...
STATIC_ROOT = '/var/www/teachercom/src/teachcom/py/static/'
...
STATICFILES_DIRS = (
    ...
    #'../teachercomapp/teachercom/static/',
)
...
SECRET_KEY = '6sap^67e+p!30@hac#8^-wj7@@am2kf^g#6x9$9ym=k*)2*b*r'
...
ROOT_URLCONF = 'teachercom.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'teachercom.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '../teachercom/teachercomapp/templates',
)
